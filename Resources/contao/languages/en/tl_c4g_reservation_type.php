...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['directBooking'] = array("Date and time are set automatically", "This function is needed if you want to use a form for direct booking. There where it must go fast (e.g. Drive Through).");
