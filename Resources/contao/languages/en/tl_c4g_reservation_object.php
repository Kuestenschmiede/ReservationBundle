...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['business_street'] = array("Street","");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['business_postal'] = array("Postal","");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['business_city'] = array("City","");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['locgeox'] = array("X coordinate", "Specify the X coordinate.");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['locgeoy'] = array("Y coordinate", "Specify the Y coordinate.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['residence_time'] = array("Maximum residence time", "Required for the calendar entry sent via email");
