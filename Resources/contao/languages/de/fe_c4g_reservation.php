...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['reservation_object_none'] = 'Reservierungswunsch nicht verfügbar.';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['additional_params'] = 'Mögliche Optionen (keine Garantie)';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['reservation_id'] = 'Reservierungsschlüssel: ';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['organisation'] = 'Firma / Organisation / Schulen ';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['address'] = 'Anschrift';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['desc_reservation_object'] = 'Wählen Sie aus was sie reservieren wollen.';
