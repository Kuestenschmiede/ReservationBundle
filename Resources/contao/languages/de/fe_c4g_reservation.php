...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['reservation_object_none'] = 'Keine Auswahl möglich';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['desc_reservation_object'] = 'Bei "Keine Auswahl" wählen Sie bitte einen anderen Zeitraum.';
