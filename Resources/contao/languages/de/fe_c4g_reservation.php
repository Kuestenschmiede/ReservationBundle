...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['reservation_object_none'] = 'Keine Auswahl vorhanden';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['desc_reservation_object'] = 'Bei "Keine Auswahl vorhanden" wählen Sie bitte einen anderen Zeitraum.';
