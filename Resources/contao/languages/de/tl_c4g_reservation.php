...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['endTime'] = array("Uhrzeit Ende", "Wann endet die Veranstaltung?");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['organisation'] = ['Firma / Organisation / Schulen ','Bitte Firmenname , Organisations oder Schulenname angeben'];
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['address'] = array("Anschrift", "Anschrift");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['comment'] = array("Kommentar", "Kommentar vom Ersteller");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['confirmed'] = array("Bestätigt", "Wurde der Termin bestätigt?Wenn es zutreffend ist, dieses Feld anwählen.");
