...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['additionaldatas'] = array("Optionale Datenfelder.","Reihenfolge hier entspricht der Anzeige im Frontend. Bis auf die Überschrift, kann jedes Feld nur einmal verwendet werden.");
