...
$GLOBALS['TL_LANG'][$str]['moveCapacity'] = array("Move capacity","The number of people entered is displayed above the participant fields. Please note: This is only useful for species where the number of people does not influence the object selection.");
...
$GLOBALS['TL_LANG'][$str]['showTagsInForm'] = array("Show tags", "Displays the object tags in the form.");
...
$GLOBALS['TL_LANG'][$str]['hideTime'] = array("Hide time", "The time selection is hidden.");
...
$GLOBALS['TL_LANG'][$str]['suspension_lists'] = array("Suspension lists", "Select the suspension lists to be taken into account.");
...
$GLOBALS['TL_LANG'][$str]['documentFileName'] = array("Change filename","The file name can contain simple tokens of the field names (e.g., ##lastname##, ##firstname##, ##documentId##, ...).");
$GLOBALS['TL_LANG'][$str]['documentIdPrefix'] = array("ID Prefix","Specify a prefix for your document ID (e.g., invoice number). Tokens like {{year}} (4 digits), {{year2}} (2 digits), {{month}} and {{day}} are supported.");
$GLOBALS['TL_LANG'][$str]['documentIdSuffix'] = array("ID Suffix","Specify a suffix for your document ID (e.g., invoice number). Tokens like {{year}} (4 digits), {{year2}} (2 digits), {{month}} and {{day}} are supported.");
