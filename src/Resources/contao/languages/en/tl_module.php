...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['occupancy_reservation_objects'] = array('Reservation objects','Select the objects whose occupancy should be displayed in the calendar.');
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['reservation_form_site'] = array('Link to reservation form', 'After clicking on a free day, you will be redirected here.');
