...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['referencesObjectType'][1] = 'Default (Time selection)';
$GLOBALS['TL_LANG']['tl_c4g_reservation']['referencesObjectType'][2] = 'Events (Call from event template)';
$GLOBALS['TL_LANG']['tl_c4g_reservation']['referencesObjectType'][3] = 'Objekt selection (BETA)';
