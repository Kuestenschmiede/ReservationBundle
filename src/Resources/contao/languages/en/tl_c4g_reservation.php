...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['documentId'] = array("Document ID", "You can define in the form settings how the document ID is generated (e.g. invoice number).");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['duration'] = array('Duration','');
$GLOBALS['TL_LANG']['tl_c4g_reservation']['internal_comment'] = array("Internal Comment", "Space for internal comments");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['man'] = array('Mr', '');
$GLOBALS['TL_LANG']['tl_c4g_reservation']['woman'] = array('Mrs', '');
$GLOBALS['TL_LANG']['tl_c4g_reservation']['various'] = array(' - ', '');
