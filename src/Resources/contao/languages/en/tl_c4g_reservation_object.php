...
$GLOBALS['TL_LANG'][$str]['allTypesEvents'] = array("Takes events into account", "Select the calendar from which you want to take into account");
...
$GLOBALS['TL_LANG'][$str]['oh_sunday'] = array("Sunday", "");
