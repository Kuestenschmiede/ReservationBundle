...
$GLOBALS['TL_LANG']['tl_c4g_settings']['fields']['taxRateStandard'] = ['Normal tax rate (VAT)', 'This sets the normal tax rate for the price calculation'];
$GLOBALS['TL_LANG']['tl_c4g_settings']['fields']['taxRateReduced'] = ['Reduced tax rate (VAT)', 'This sets the reduced tax rate for the price calculation.'];