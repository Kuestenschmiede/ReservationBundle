...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['referencesObjectType'][2] = 'Events (Call from event template)';
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['referencesObjectType'][3] = 'Objekt selection (BETA)';
