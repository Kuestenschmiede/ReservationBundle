...
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['email'] = array("Email address", "First name");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['phone'] = array("Phone number", "Phone number");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['address'] = array("Street", "Street");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['checkedIn'] = array('Person is on site (check-in).','');
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['payed'] = array('Reservation has been paid.','');
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['edit'] = array("Edit participants","Edit participants ID %s");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['copy'] = array("Copy participants","Copy participants ID %s");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['delete'] = array("Delete participants","Delete participants ID %s");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['show'] = array("Display participants","Display participants ID %s");
$GLOBALS['TL_LANG']['tl_c4g_reservation_participants']['TOGGLE'] = array("Activate participants","Activate participants ID %s");
