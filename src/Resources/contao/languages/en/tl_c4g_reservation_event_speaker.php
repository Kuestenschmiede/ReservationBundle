...
$GLOBALS['TL_LANG'][$str]['published'] = array("Publish", "Do you want the speaker to be displayed in the frontend?");

/** LEGENDS **/
$GLOBALS['TL_LANG'][$str]['speaker_legend'] = "Edit speaker";

/** OPERATIONS **/
$GLOBALS['TL_LANG'][$str]['new'] = array("Add speaker", "Add speaker");
$GLOBALS['TL_LANG'][$str]['edit'] = array("Edit speaker", "Edit speaker ID %s");
$GLOBALS['TL_LANG'][$str]['copy'] = array("Copy speaker", "Copy speaker ID %s");
$GLOBALS['TL_LANG'][$str]['delete'] = array("Delete speaker", "Delete speaker ID %s");
$GLOBALS['TL_LANG'][$str]['show'] = array("Show speaker", "Show speaker ID %s");
$GLOBALS['TL_LANG'][$str]['TOGGLE'] = array("Enable speaker", "Enable speaker ID %s");
