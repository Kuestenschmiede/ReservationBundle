...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['options'] = array("Frontendbezeichnung","Wird alternativ im Frontend dargestellt.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['day_interval'] = array("Tageintervall", "Alle wie viele Tage kann das Reservierungsobjekt während der Öffnungszeiten gebucht werden.");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['week_interval'] = array("Wochenintervall", "Alle wie viele Wochen kann das Reservierungsobjekt während der Öffnungszeiten gebucht werden.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['description'] = array("Beschreibung","Beschreibung der Reservierungsmöglichkeit (wird im Frontend dargestellt).");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['image'] = array("Bild", "Passendes Bild zur Reservierungsmöglichkeit (wird im Frontend dargestellt).");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['day'] = array("Tage");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['week'] = array("Wochen");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['min_residence_time'] = array("Minimale Nutzungsdauer (optional)", "Minimale Nutzungsdauer, die der Kunde im Formular wählen darf. Wichtig für mehrtägige Buchungen (Tage, Wochen). Achtung! Gilt nur für die Reservierungsart Objektwahl. Bei 0 gilt das Zeitintervall.");
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['max_residence_time'] = array("Maximale Nutzungsdauer (optional)", "Maximale Nutzungsdauer, die der Kunde im Formular wählen darf. Wichtig für mehrtägige Buchungen (Tage, Wochen). Achtung! Gilt nur für die Reservierungsart Objektwahl. Bei 0 gilt das Zeitintervall.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['time_interval_legend'] = "Intervalleinstellungen (Abhängig von der Art)";
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['day_legend'] = "Tageeinstellung";
$GLOBALS['TL_LANG']['tl_c4g_reservation_object']['week_legend'] = "Wocheneinstellung";
