...
$GLOBALS['TL_LANG'][$str]['allTypesEvents'] = array("Contao Events blockieren Objekte", "Wählen Sie die Kalender aus, die bei der Prüfung freier Termine berücksichtigt werden sollen.");
...
$GLOBALS['TL_LANG'][$str]['typeOfObject'] = array('Art des Objektes', 'Ordnen Sie das Reservierungsobjekt einer Objektart zu. Wichtig! Gilt derzeit nur für die "Objektauswahl" (Einstellung an der Reservierungsart).');
