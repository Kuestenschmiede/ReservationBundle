...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['occupancy_reservation_objects'] = array('Reservierungsobjekte','Auswahl der Objekte, deren Belegung im Kalender angezeigt werden soll.');
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['reservation_form_site'] = array('Link zum Reservierungsformular', 'Nach dem Klick auf einen freien Tag wird hierhin weitergeleitet.');
...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['selectReservationTypes'] = array('Reservierungsarten', 'Wählen Sie die bei der Reservierung im Frontend zu berücksichigenden Reservierungsarten (Räume, Tische, ...). Bei keiner Auswahl werden alle Reservierungsobjekte geladen.');
...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['fields']['cancellationButtonCaption'] = array('Beschriftung Absendebutton','Hiermit können Sie den Button Text ändern. Bspw. "Reservierung Stornieren".');
...
$GLOBALS['TL_LANG']['tl_module']['c4g_reservation']['references']['memberview'] = 'Mitgliederansicht (Nur Reservierungen für angemeldetes Mitglied, nicht editierbar) [erfordert con4gis/groups]';
