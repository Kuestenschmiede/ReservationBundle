...
$GLOBALS['TL_LANG'][$str]['showCompany'] = array("Firmenname im Belegungsplan anzeigen", "Zeigt den Firmennamen im Belegungsplan an.");
...
$GLOBALS['TL_LANG'][$str]['company'] = array("Firmenname", "Geben Sie hier den Firmennamen ein.");
