...
/** FIELDS */
$GLOBALS['TL_LANG']['fe_c4g_reservation']['checkedIn'] = 'Einchecken';
/** BUTTONS */
$GLOBALS['TL_LANG']['fe_c4g_reservation']['button_checkin'] = 'Jetzt einchecken';

/** INFO */
$GLOBALS['TL_LANG']['fe_c4g_reservation_checkin']['reservation_checkin_none'] = 'Fehler: Kein CheckIn-Schlüssel vorhanden.';
