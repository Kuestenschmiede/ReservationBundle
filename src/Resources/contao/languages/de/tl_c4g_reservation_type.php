...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['alias'] = array("Alias", "Der Alias wird im Frontend anstelle der ID für Detailansichten und Parameter benutzt.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['default_residence_time'] = array("Standard Nutzungsdauer (optional)", "Standard Nutzungsdauer, die im Formular vorbelegt wird. Bei 0 wird der niedrigste Werte gewählt.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['severalBookings'] = array("Objekte mehrfach buchbar","Alle Objekte des Typs können mehrfach gebucht werden. Nur sinnvoll mit Personenangabe und Objekttype 'Objektauswahl'. Eine bereits gebuchte Personenzahl wird subtrahiert.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['maxParticipantsPerBooking'] = array("Maximale Teilnehmerzahl pro Buchung", "Hierüber können Sie die Teilnehmerzahl in der Eingabe pro Buchung begrenzen. 0 = unbegrenzt. Sollten Sie den Teilnehmermechanismus im Formular nutzen wollen, dann sollten Sie hier die Anzahl stark eingrenzen (max. 10 Personen).");
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['ignoreCapacity'] = array("Personenzahl nicht erforderlich", "Wählen Sie diese Option, wenn die Personenzahl im Reservierungsformular nicht abgefragt werden soll.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['cloneObject'] = array("Klonvorlage (Objekt)", "Achtung! Nur notwendig bei der Frontendpflege von Objekten. Das Objekt wird nur für die Frontenderstellung benötigt. Komplexere Einstellungen werden bei der Erstellung neuer Objekte der selben Art übernommen.");
