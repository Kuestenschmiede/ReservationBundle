...
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['referencesObjectType'][2] = 'Events (Aufruf aus dem Event-Template)';
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['referencesObjectType'][3] = 'Objektauswahl (BETA)';
$GLOBALS['TL_LANG']['tl_c4g_reservation_type']['notification_type'] = array('Automatische Bestätigungsnachricht (optional)', 'Wählen Sie die Benachrichtigung aus. Diese Einstellung überschreibt die Reservierungsformular Einstellungen.');
