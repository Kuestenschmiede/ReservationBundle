...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['duration'] = array("Verweildauer", "Angabe in Stunden oder Minuten. Abhängig von der Einstellung in der Reservierungsart.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['day'] = array("Tage");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['overnight'] = array("Übernachtungen");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['week'] = array("Wochen");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['referencesObjectType'][3] = 'Objektauswahl';
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['discountCode'] = array("Rabattcode", "Der Rabattcode wurde / wird bei der Preisberechnung berücksichtigt.");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['documentId'] = array("Dokument-ID", "Sie können in den Formulareinstellungen definieren wie die Dokument-ID generiert wird (z.B. Rechnungsnummewr).");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['checkedIn'] = array("Eingecheckt","Gast vor Ort bzw. Ticket entwertet.");
$GLOBALS['TL_LANG']['tl_c4g_reservation']['payed'] = array("Reservierung wurde bezahlt.","");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation']['additional_legend']  = "Zusatzinformationen";
