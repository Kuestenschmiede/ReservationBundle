...
//$GLOBALS['TL_LANG']['tl_c4g_reservation']['qrCode'] = array("QR Code", "Der QR-Code wird nicht im Formular angezeigt. Kann hier aber für den PDF-Druck aktiviert werden.");
