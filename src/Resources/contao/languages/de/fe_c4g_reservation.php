...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['duration_caption'] = "Individuelle Nutzungsdauer &nbsp(";
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['documentId'] = 'Rechnungsnummer';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['headlineBill'] = 'Rechnung Nr.';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['creditInstitute'] = 'Kreditinstitut';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['iban'] = 'IBAN';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['bic'] = 'BIC';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['discountCode'] = 'Rabattcode';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['pNight'] = " pro Übernachtung";
$GLOBALS['TL_LANG']['fe_c4g_reservation']['pNightPerson'] = " pro Übernachtung und Person";
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['desc_reservation_id'] = 'Wichtig!&nbsp Eindeutiger Schlüssel für Änderungen oder Stornierungen.';
...
$GLOBALS['TL_LANG']['fe_c4g_reservation']['desc_agreed_without_link'] = '&nbsp Detaillierte Informationen zum Umgang mit Nutzerdaten in unserer Datenschutzerklärung.';
...
/** OCCUPANCY PLAN */
$GLOBALS['TL_LANG']['fe_c4g_reservation']['occupancy_legend'] = 'Legende';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['occupancy_free'] = 'Frei';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['occupancy_booked'] = 'Belegt';
$GLOBALS['TL_LANG']['fe_c4g_reservation']['occupancy_partial'] = 'Teilweise belegt';
