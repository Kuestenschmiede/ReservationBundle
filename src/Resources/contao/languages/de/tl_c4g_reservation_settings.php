...
$GLOBALS['TL_LANG'][$str]['reservationButtonCaption'] = array('Buttonbeschriftung','Hiermit können Sie den Button Text ändern. Bspw. "Zahlungspflichtig reservieren".');
$GLOBALS['TL_LANG'][$str]['redirect_site'] = array('Weiterleitungsseite', 'Nach der Buchung wird hierhin weitergeleitet.');
...
$GLOBALS['TL_LANG'][$str]['privacy_policy_text'] = array('Datenschutzkommentar', 'Dieser Datenschutzkommentar taucht vor der Checkbox zur Einwilligung auf.');
...
$GLOBALS['TL_LANG'][$str]['additionaldatas'] = array("Datenfelder","Reihenfolge hier entspricht der Anzeige im Frontend. Bis auf die Überschrift, kann jedes Feld nur einmal verwendet werden.");
...
$GLOBALS['TL_LANG'][$str]['fieldSelection'] = array("Datenfelder Hinzufügen","Achtung! Vorname, Nachname und E-Mail werden angehangen, falls diese fehlen. Die drei Felder sind immer erforderlich.");
$GLOBALS['TL_LANG'][$str]['additionalDuration'] = array("Individuelle Verweildauer in Minuten (maximal)","Bei 0 ist keine individuelle Eingabe der Verweildauer in Minuten möglich (Standard).");
...
$GLOBALS['TL_LANG'][$str]['showDetails'] = array("Objektdetails anzeigen","Zusatzinformationen wie Bild und Beschreibung werden dargestellt.");
...
$GLOBALS['TL_LANG'][$str]['emptyOptionLabel'] = array("Text leere Objektliste (optional)","Der Text der Selectbox kann optional überschrieben werden.");
$GLOBALS['TL_LANG'][$str]['specialParticipantMechanism'] = array("Teilnehmermechanismus (optional)","Ist dieser Mechanismus aktiviert, werden die Teilnehmerfelder anhand der Personenzahl generiert.");
