...
$GLOBALS['TL_LANG'][$str]['hideReservationKey'] = array("Reservierungsschlüssel ausblenden", "Wenn diese Option aktiviert ist, wird der Reservierungsschlüssel im Frontend nicht angezeigt.");
