...
$GLOBALS['TL_LANG'][$str]['documentIdPrefix'] = array("ID Präfix","Geben Sie einen Präfix für Ihre Dokument-ID an (z.B. Rechnungsnummer). Ersetzungsparameter wie {{year}} (vierstellig), {{year2}} (zweistellig), {{month}} und {{day}} werden unterstützt.");
$GLOBALS['TL_LANG'][$str]['documentIdSuffix'] = array("ID Suffix","Geben Sie einen Suffix für Ihre Dokument-ID an (z.B. Rechnungsnummer). Ersetzungsparameter wie {{year}} (vierstellig), {{year2}} (zweistellig), {{month}} und {{day}} werden unterstützt.");
...
$GLOBALS['TL_LANG']['tl_c4g_reservation_settings']['noDocument'] = 'Kein Dokument';
/** LEGENDS **/
