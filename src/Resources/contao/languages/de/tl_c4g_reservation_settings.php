...
$GLOBALS['TL_LANG'][$str]['objectHide'] = array('Reservierungsobject verstecken', 'Wichtig!! Nur sinnvoll bei Verwendung von Insert-Tags. Bspw. "{{c4gevent::title}}". Wenn diese Option aktiviert ist, wird der Reservierungsname im Frontend nicht angezeigt.');
...
$GLOBALS['TL_LANG'][$str]['reservationKeyHide'] = array("Reservierungsschlüssel verstecken", "Wenn diese Option aktiviert ist, wird der Reservierungsschlüssel im Frontend nicht angezeigt.");
