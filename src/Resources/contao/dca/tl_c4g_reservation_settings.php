...
(
    ...
    (
       ...
       'withCapacity' => array
        ...
        'showTagsInForm' => array
        (   'label'             => &$GLOBALS['TL_LANG']['tl_c4g_reservation_settings']['showTagsInForm'],
            'exclude'           => true,
            'filter'            => true,
            'inputType'         => 'checkbox',
            'sql'               => "int(1) unsigned NULL default 0"
        ...
        'showMinMaxWithCapacity' => array
        (   'label'             => &$GLOBALS['TL_LANG']['tl_c4g_reservation_settings']['showMinMaxWithCapacity'],
            'exclude'           => true,
            'filter'            => true,
            'inputType'         => 'checkbox',
            'sql'               => "int(1) unsigned NULL default 0"
        ...
        'onlyParticipants' => array
        (   'label'             => &$GLOBALS['TL_LANG']['tl_c4g_reservation_settings']['onlyParticipants'],
            'exclude'           => true,
            'filter'            => true,
            'inputType'         => 'checkbox',
            'sql'               => "int(1) unsigned NULL default 0"
