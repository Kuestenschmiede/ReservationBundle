...
$GLOBALS['TL_DCA']['tl_c4g_reservation_event_topic'] = array
(
    //config
    'config' => array
    (
    ...
    (
        'id' => array
        (
            'label'             => &$GLOBALS['TL_LANG']['tl_c4g_reservation_event_topic']['id'],
        ...
        'topic' => array (
            'label'                   => &$GLOBALS['TL_LANG']['tl_c4g_reservation_event_topic']['topic'],
            'exclude'                 => true,
            'filter'                  => false,
            'search'                  => false,
            'sorting'                 => false,
 ...
 */
class tl_c4g_reservation_event_topic extends Backend
{
    /**
