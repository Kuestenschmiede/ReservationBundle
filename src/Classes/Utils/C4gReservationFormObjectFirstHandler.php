...
//        $captions = StringUtil::deserialize($object['options']);
        ...
        // are appended centrally by the Controller to avoid duplication across handlers.

        return $this->fieldList;
    }

    // Removed handler-local getStaticFieldBlueprint(): static fields are appended by the Controller.
}